            ...
            >
                ...
                <View className="flex flex-col gap-8">
                    ...
                    <ThemedView lightColor="transparent" darkColor="transparent">
                        ...
                        <Button className="flex flex-row my-6 h-14 bg-[#F5F5F5] justify-start p-2 rounded-lg items-center" onPress={() => handleLoginGoogle()}>
                    ...
                    <ThemedView>
                        <View style={{ display: 'flex', flexDirection: 'column', rowGap: 18 }}>
                            ...
                            <View>
                                <ThemedText style={{ fontSize: 18 }} type="subtitle">Confirmar contraseña</ThemedText>
                                <TextInput
                                    ...
                                    style={{ borderRadius: 10, padding: 16, backgroundColor: '#F5F5F5', borderWidth: 1, borderColor: confirmPasswordFocused ? "#000000" : "transparent" }}
                                />
                            </View>
